...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IndependentProbe) DeepCopyInto(out *IndependentProbe) {
	*out = *in
	if in.Period != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IndependentProbe.
func (in *IndependentProbe) DeepCopy() *IndependentProbe {
	if in == nil {
		return nil
	}
	out := new(IndependentProbe)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NetworkProblemDetector) DeepCopyInto(out *NetworkProblemDetector) {
	*out = *in
	...
	if in.IndependentProbes != nil {
		in, out := &in.IndependentProbes, &out.IndependentProbes
		*out = make([]IndependentProbe, len(*in))
		for i := range *in {
