...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*IndependentProbe)(nil), (*config.IndependentProbe)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_IndependentProbe_To_config_IndependentProbe(a.(*IndependentProbe), b.(*config.IndependentProbe), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.IndependentProbe)(nil), (*IndependentProbe)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_IndependentProbe_To_v1alpha1_IndependentProbe(a.(*config.IndependentProbe), b.(*IndependentProbe), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*K8sExporter)(nil), (*config.K8sExporter)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_K8sExporter_To_config_K8sExporter(a.(*K8sExporter), b.(*config.K8sExporter), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.K8sExporter)(nil), (*K8sExporter)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_K8sExporter_To_v1alpha1_K8sExporter(a.(*config.K8sExporter), b.(*K8sExporter), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_IndependentProbe_To_config_IndependentProbe(in *IndependentProbe, out *config.IndependentProbe, s conversion.Scope) error {
	out.JobID = in.JobID
...
// Convert_v1alpha1_IndependentProbe_To_config_IndependentProbe is an autogenerated conversion function.
func Convert_v1alpha1_IndependentProbe_To_config_IndependentProbe(in *IndependentProbe, out *config.IndependentProbe, s conversion.Scope) error {
	return autoConvert_v1alpha1_IndependentProbe_To_config_IndependentProbe(in, out, s)
}

func autoConvert_config_IndependentProbe_To_v1alpha1_IndependentProbe(in *config.IndependentProbe, out *IndependentProbe, s conversion.Scope) error {
	out.JobID = in.JobID
...
// Convert_config_IndependentProbe_To_v1alpha1_IndependentProbe is an autogenerated conversion function.
func Convert_config_IndependentProbe_To_v1alpha1_IndependentProbe(in *config.IndependentProbe, out *IndependentProbe, s conversion.Scope) error {
	return autoConvert_config_IndependentProbe_To_v1alpha1_IndependentProbe(in, out, s)
}
...
func Convert_v1alpha1_K8sExporter_To_config_K8sExporter(in *K8sExporter, out *config.K8sExporter, s conversion.Scope) error {
	return autoConvert_v1alpha1_K8sExporter_To_config_K8sExporter(in, out, s)
}
...
func Convert_config_K8sExporter_To_v1alpha1_K8sExporter(in *config.K8sExporter, out *K8sExporter, s conversion.Scope) error {
	return autoConvert_config_K8sExporter_To_v1alpha1_K8sExporter(in, out, s)
}
...
func autoConvert_v1alpha1_NetworkProblemDetector_To_config_NetworkProblemDetector(in *NetworkProblemDetector, out *config.NetworkProblemDetector, s conversion.Scope) error {
	...
	out.IndependentProbes = *(*[]config.IndependentProbe)(unsafe.Pointer(&in.IndependentProbes))
	return nil
}
...
func autoConvert_config_NetworkProblemDetector_To_v1alpha1_NetworkProblemDetector(in *config.NetworkProblemDetector, out *NetworkProblemDetector, s conversion.Scope) error {
	...
	out.IndependentProbes = *(*[]IndependentProbe)(unsafe.Pointer(&in.IndependentProbes))
	return nil
}
