...
import (
	...
	_ "github.com/gardener/gardener-extension-shoot-networking-problemdetector/test/integration/healthcheck"
)
...
func TestGardenerSuite(t *testing.T) {
	RunSpecs(t, "shoot-networking-problemdetector Test Suite")
}
