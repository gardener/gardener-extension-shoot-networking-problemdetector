...
require (
	...
	github.com/gardener/network-problem-detector v0.11.1-0.20230119154702-f88bf33be264
...
// temporarily fix to avoid missing package used by github.com/gardener/etcd-druid (import problem)
