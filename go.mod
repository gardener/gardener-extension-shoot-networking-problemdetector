...
require (
	...
	github.com/gardener/network-problem-detector v0.29.0
...
require (
	...
	github.com/gardener/etcd-druid/api v0.32.0 // indirect
	...
	github.com/open-telemetry/opentelemetry-operator v0.135.0 // indirect
